...
function AsideBar(props) {
  ...
  // BlackPad Dropdown
  const [isBlackPadDropdown, setBlackPadDropdown] = useState(false);

  // BlackLock Dropdown
  const [isBlackLockDropdown, setBlackLockDropdown] = useState(false);

  // BlackAirdrop
  const [isBlackAirdropDropdown, setBlackAirdropDropdown] = useState(false);
      ...
      <div className="wrapper">
        <ul className="aside_list">
          ...
          <li className="aside_list_item">
            <button
              className="aside_list_action"
              onClick={() => setBlackPadDropdown(!isBlackPadDropdown)}
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <i
              className={`fa-solid fa-angle-down ${
                isBlackPadDropdown ? "active_icon" : ""
              }`}
            ></i>
            <div className="dropdown_list"></div>
          </li>
          <li className="aside_list_item">
            <button
              className="aside_list_action"
              onClick={() => setBlackLockDropdown(!isBlackLockDropdown)}
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <i
              className={`fa-solid fa-angle-down ${
                isBlackLockDropdown ? "active_icon" : ""
              }`}
            ></i>
            <div className="dropdown_list"></div>
          </li>
          ...
          <li className="aside_list_item">
            <button
              className="aside_list_action"
              onClick={() => setBlackAirdropDropdown(!isBlackAirdropDropdown)}
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <i
              className={`fa-solid fa-angle-down ${
                isBlackAirdropDropdown ? "active_icon" : ""
              }`}
            ></i>
            <div className="dropdown_list"></div>
          </li>
          ...
          <div className="flex_box">
            <div className="flex_box_item">
              <a href="#">
                <img
                  style={{ height: "18px" }}
                  src={require("../../Static/img/blackswap.a95de4f3.png")}
                  alt="img"
                />{" "}
                <span> BlackSALE</span>
              </a>
