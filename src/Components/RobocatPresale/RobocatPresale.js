...
import "./RobocatPresale.css";
function RobocatPresale(props) {
  ...
  return (
    <div id="RobocatPresale">
      <div className="Robocatpresale_wrapper">
        <div className="Robocat_card">
            ...
            <div className="card_box">
              <div className="card_subBox">
                <img
                  ...
                  src={require("../../Static/img/Robocat.png")}
                  alt="img"
                />

                <div className="content_box">
                  <strong>$Robocat Presale</strong>
                  ...
                  <p className="content_pera">
                    💎Robocat Presale💎 Whitelist contest > https://t.ly/vH9f
                    ...
                    back+burn) ✅TEAM DOXXED/KYC ✅REGISTERED COMPANY Robocat
